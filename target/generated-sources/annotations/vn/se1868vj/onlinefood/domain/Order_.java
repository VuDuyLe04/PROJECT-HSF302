...
public abstract class Order_ {
	...
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#receiverAddress
	 **/
	public static volatile SingularAttribute<Order, String> receiverAddress;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#orderDetails
	 **/
	public static volatile ListAttribute<Order, OrderDetail> orderDetails;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#receiverPhone
	 **/
	public static volatile SingularAttribute<Order, String> receiverPhone;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#totalPrice
	 **/
	public static volatile SingularAttribute<Order, Double> totalPrice;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#receiverName
	 **/
	public static volatile SingularAttribute<Order, String> receiverName;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#id
	 **/
	public static volatile SingularAttribute<Order, Long> id;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order
	 **/
	public static volatile EntityType<Order> class_;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#orderDate
	 **/
	public static volatile SingularAttribute<Order, LocalDateTime> orderDate;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#user
	 **/
	public static volatile SingularAttribute<Order, User> user;
	
	/**
	 * @see vn.se1868vj.onlinefood.domain.Order#status
	 **/
